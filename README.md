...
<details>
<summary><b>Comandos Ocultos</b></summary>

  - [x] **✅ Activar de forma automática**<br>
  _Para instalar de forma automática, dirijase a este apartado del creador ☞︎︎︎ [`👑 Creador 👑`](https://api.whatsapp.com/send?phone=+5493873687620), para pedir el codigo de instalación automática para termux, o tambien lo puede pedir en `Guardian Bot MD` justamente en este apartado ☞︎︎︎ [`🛡️Guardian Bot MD 🛡️`](https://api.whatsapp.com/send?phone=+5493873650768)._
  
  - [x] **✅ Agregar numero como owner o sub creador/a**<br>
  _Puedes ir al contacto oficial de `Guardian Bot MD` y pedir que te de como owner o sub creador/a del bot, [`🛡️ Guardian Bot MD 🛡️`](https://api.whatsapp.com/send?phone=+5493873650768)._

  - [x] **✅ Idioma del bot**<br>
  _Puede cambiar de idioma con `Guardian Bot MD`, o si usted quiere cambiar, puede comunicarse con el o al creador, para que te de el permiso de uso del bot, para que usted lo maneje a su manera.._
  _🍓Nota🍓 el idioma coreano no esta disponible aun, lo estara en proximas actualizaciones del bot, en cuanto se pueda, pueden ser comunicados con el creador o guardian bot md._
  
  - [x] **✅ Video para mostrar de cómo se instala**<br>
  _Puede ver el video de instalación del bot, para que sea mas facil instalarlo siguiendo las instrucciones, lo cual estara dos videos, el de `Instalacion automática` y `Instalacion manual`, puede comunicarse con el creador [`👑 Creador 👑`](https://api.whatsapp.com/send?phone=+5493873687620), o con [`🛡️ Guardian Bot MD 🛡️`](https://api.whatsapp.com/send?phone=+5493873650768) para pedir el video de la instalación._
</details>
----
