...
if (!args[0] || !args[1]) throw lenguajeEB.smsAudioEdit1(usedPrefix, command)
...
if (!args[0] || !args[1]) throw lenguajeEB.smsAudioEdit2(usedPrefix, command)
if (isNaN(args[0]) || isNaN(args[1])) return replyToNumber()  
if (!mime) return replyToAudio()
let f, d
...
if (!args[0] || !args[1]) throw lenguajeEB.smsAudioEdit3(usedPrefix, command)
if (isNaN(args[0]) || isNaN(args[1])) return replyToNumber()  
if (!mime) return replyToAudio()
...
if (!args[0] || !args[1]) throw lenguajeEB.smsAudioEdit4(usedPrefix, command)
let atempo, asetrate
if (isNaN(args[0]) || isNaN(args[1])) return replyToNumber()  
if (!mime) return replyToAudio()
...
if (!args[0] || !args[1]) throw lenguajeEB.smsAudioEdit6(usedPrefix, command)
if (isNaN(args[0]) || isNaN(args[1])) return replyToNumber()  
if (!mime) return replyToAudio()
let tempo, setrate
...
if (!args[0] || !args[1]) throw lenguajeEB.smsAudioEdit7(usedPrefix, command)
if (isNaN(args[0]) || isNaN(args[1])) return replyToNumber()  
if (!mime) return replyToAudio()
let tempo, setrate
...
if (!args[0] || !args[1]) throw lenguajeEB.smsAudioEdit8(usedPrefix, command)
if (isNaN(args[0]) || isNaN(args[1])) return replyToNumber()  
if (!mime) return replyToAudio()
...
if (!args[0] || !args[1]) throw lenguajeEB.smsAudioEdit9(usedPrefix, command)
if (isNaN(args[0]) || isNaN(args[1])) return replyToNumber()  
if (!mime) return replyToAudio()
...
if (!args[0] || !args[1]) throw lenguajeEB.smsAudioEdit10(usedPrefix, command)
if (isNaN(args[0]) || isNaN(args[1])) return replyToNumber()  
if (!mime) return replyToAudio()
...
if (!args[0] || !args[1]) throw lenguajeEB.smsAudioEdit11(usedPrefix, command)
if (isNaN(args[0]) || isNaN(args[1])) return replyToNumber()
if (!mime) return replyToAudio()
...
if (!args[0] || !args[1]) throw lenguajeEB.smsAudioEdit12(usedPrefix, command)
...
if (!args[0] || !args[1]) throw lenguajeEB.smsAudioEdit13(usedPrefix, command)
...
} else throw lenguajeEB.smsControlAudio4()
} catch (e) {
throw e
}}
