...
if (stiker) {
conn.sendFile(m.chat, stiker, 'sticker.webp', '', null, true, { contextInfo: { 'forwardingScore': 200, 'isForwarded': false, externalAdReply:{ showAdAttribution: false, title: packname, body: '❤︎ STICKER ❤︎', mediaType: 2, sourceUrl: redesMenu.getRandom(), thumbnail: egoImg.getRandom()}}})
} else {
...
handler.command = /^(s(tickers?)?(image|JiminSticker|video|gif|img)?)$/i
