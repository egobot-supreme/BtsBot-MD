...
const smsAvisoMG = () => { return `╔ೋ❀❀ೋ══❲🚀❳══ೋ❀❀ೋ╗\n╟❬❤️❭꙳꙰➣ *_AÇÃO INADEQUADA_*\n╚ೋ❀❀ೋ══❲🚀❳══ೋ❀❀ೋ╝\n\n` }
const smsAvisoEEG = () => { return `╔ೋ❀❀ೋ══❲📂❳══ೋ❀❀ೋ╗\n╟❬❤️❭꙳꙰➣ *_RELATÓRIO_*\n╚ೋ❀❀ೋ══❲📂❳══ೋ❀❀ೋ╝\n\n` }
const smsAvisoEG = () => { return `╔ೋ❀❀ೋ══❲🍀❳══ೋ❀❀ೋ╗\n╟❬❤️❭꙳꙰➣ *_SUCESSO_*\n╚ೋ❀❀ೋ══❲🍀❳══ೋ❀❀ೋ╝\n\n` }

//PARÂMETROS EM COMANDOS
const smsRowner = () => { return `\`\`\`*_❮🍰❯ ESSE COMANDO SÓ EU COMO CRIADOR DE BOT PODE USAR._*\`\`\`` }
const smsOwner = () => { return `\`\`\`*_❮🍰❯ ESSE COMANDO SÓ MEU CRIADOR PODE USAR._*\`\`\`` }
const smsMods = () => { return `\`\`\`*_❮🍰❯ ESSE COMANDO SOMENTE MODERADORES E MEU CRIADOR PODEM USAR._*\`\`\`` }
const smsPremium = () => { return `\`\`\`*_❮🍰❯ ESSE COMANDO APENAS ESTÁ DISPONÍVEL PARA USUÁRIOS PREMIUM E MEU CRIADOR, PARA OBTER PREMIUM COMPRE UM PASS USANDO:_* #pass premium\`\`\`` }
const smsGroup = () => { return `\`\`\`*_❮🍰❯ ESSE COMANDO SÓ PODE SER USADO EM GRUPOS._*\`\`\`` }
const smsPrivate = () => { return `\`\`\`*_❮🍰❯ ESSE COMANDO SÓ PODE SER USADO PARA O PRIVADO._*\`\`\`` }
const smsAdmin = () => { return `\`\`\`*_❮🍰❯ ESSE COMANDO É SOMENTE PARA ADMINISTRADORES._*\`\`\`` }
const smsBotAdmin = () => { return `\`\`\`*_❮🍰❯ PRECISO SER ADMIN PARA QUE VOCÊ POSSA USAR ESTE COMANDO._*\`\`\`` }
const smsUnreg = () => { return `\`\`\`*_❮🍰❯ VOCÊ PRECISA ESTAR REGISTRADO PARA USAR ESTE COMANDO, DIGITE #verify PARA REGISTRAR._*\`\`\`` }
const smsRestrict = () => { return `\`\`\`*_❮🍰❯ ESSE COMANDO É RESTRITO PELO MEU CRIADOR._*\`\`\`` }
...
const smsCont7 = () => { return `${global.lenguajeEB['smsAvisoAG']()}*NÃO TEM DIAMANTES!! 💎 VOCÊ PODE IR À LOJA COM O COMANDO*`}
const smsCont8 = () => { return ` *DIAMANTE 💎 USADO*`}
const smsCont9 = () => { return `${global.lenguajeEB['smsAvisoAG']()}*PRECISO DO NÍVEL ➡️*`}
...
//_antilink.js
const smsAdwa = () => { return `${global.lenguajeEB['smsAvisoEG']()}*COMO VOCÊ É ADMINISTRADOR NESTE GRUPO, VOCÊ NÃO SERÁ REMOVIDO*`}
const smsEnlaceWat = () => { return `${lenguajeEB['smsAvisoAG']()}*UM LINK DE WHATSAPP BANIDO FOI DETECTADO NESTE GRUPO*\n\n*EU CONTINUO A TE EXCLUIR*`}

//_antilink2.js
const smsEnlaceWatt = () => { return `${lenguajeEB['smsAvisoAG']()}UM LINK PROIBIDO CONTENDO HTTPS FOI DETECTADO NESTE GRUPO\n\nEU CONTINUO A TE EXCLUIR`}
...
//Erro
const smsMalError = () => { return `${lenguajeEB['smsAvisoFG']()}\`\`\`OCORREU UM ERRO INESPERADO.\`\`\``}
const smsMalError2 = () => { return `${lenguajeEB['smsAvisoFG']()}\`\`\`SURGIU UMA INCONVENIÊNCIA. TENTE NOVAMENTE.\`\`\``}
const smsMalError3 = () => { return `${lenguajeEB['smsAvisoFG']()}\`\`\`ALGO DEU ERRADO, DENUNCIE ESTE COMANDO USANDO:\`\`\`\n`}
...
//_autosticker.js
const smsAutoStik = () => { return `${lenguajeEB['smsAvisoFG']()}*O VÍDEO NÃO DEVE DURAR MAIS DE 7 SEGUNDOS.*`} 
...
//afk-_afk.js
const smsAfkM1 = () => { return `${lenguajeEB['smsAvisoEG']()}*VOCÊ DEIXOU DE SER OCIOSO AFK*`} 
const smsAfkM2 = () => { return `*O MOTIVO DA INATIVIDADE FOI:*`} 
const smsAfkM3 = () => { return `*TEMPO INATIVO:*`} 
const smsAfkM4 = () => { return `${lenguajeEB['smsAvisoAG']()}*NÃO MARQUE ESSE USUÁRIO!! ESTÁ INATIVO*`} 
...
//afk-afk.js
const smsAfkM1A = () => { return `${lenguajeEB['smsAvisoAG']()}*NÃO MARQUE*`} 
const smsAfkM1B = () => { return `*ESTARÁ INATIVO AFK*\n\n*MOTIVO DA INATIVIDADE AFK*`} 

//anonymous_chat.js
const smsChatAn1 = () => { return `${lenguajeEB['smsAvisoFG']()}*VOCÊ NÃO ESTÁ NO CHAT ANÔNIMO*`} 
...
const smsChatAn4 = () => { return `${lenguajeEB['smsAvisoRG']()}🪐 *VOCÊ SAIU DO CHAT ANÔNIMO*`} 
const smsChatAn5 = () => { return `${lenguajeEB['smsAvisoAG']()}*O OUTRO USUÁRIO SAIU DO CHAT ANÔNIMO*`}  
const smsChatAn6 = () => { return `*SE QUISER IR PARA OUTRO CHAT ANÔNIMO USE O COMANDO #start OU ACESSE O BOTÃO ABAIXO*\n`} 
const smsChatAn7 = () => { return `${lenguajeEB['smsAvisoAG']()}*VOCÊ AINDA ESTÁ EM UM CHAT ANÔNIMO OU ESPERANDO QUE ALGUÉM ENTRE NO CHAT*`} 
...
const smsChatAn10 = () => { return `${lenguajeEB['smsAvisoEG']()}✨ *ELES PODEM CONVERSAR AGORA*`} 
const smsChatAn11 = () => { return `*ALGUÉM ENTROU NO CHAT ANÔNIMO!!*`} 
const smsChatAn12 = () => { return `❇️ OUTRO USUÁRIO`} 
const smsChatAn13 = () => { return `${lenguajeEB['smsAvisoRG']()}🐈 *ESPERANDO ALGUÉM ENTRAR NO CHAT ANÔNIMO, SEJA PACIENTE*`} 
...
const smsMalused2 = () => { return `${lenguajeEB['smsAvisoMG']()}🐈 *VOCÊ DEVE USAR O COMANDO COMO ESTE EXEMPLO:*\n`}
const smsMalused3 = () => { return `${lenguajeEB['smsAvisoMG']()}🐈 *VOCÊ DEVE USAR O COMANDO OU RESPONDER À MENSAGEM DE ALGUÉM COMO ESTE EXEMPLO:*\n`}
...
//grupo-add.js
const smsAddB1 = () => { return `${lenguajeEB['smsAvisoFG']()}*NÃO É POSSÍVEL ADICIONAR NÚMERO, POR FAVOR VERIFIQUE SE ESTÁ CORRETO, TALVEZ SEJA RECENTEMENTE OU SUA PRIVACIDADE ESTÁ DEFINIDA.*`}
const smsAddB2 = () => { return `${lenguajeEB['smsAvisoFG']()}*NÃO É POSSÍVEL ADICIONAR O NÚMERO, VERIFICAR SE ESTÁ CORRETO OU ADICIONAR MANUALMENTE.*`}
...
const smsAdveu1 = () => { return `${lenguajeEB['smsAvisoAG']()}*SÓ PODE USAR SE A FUNÇÃO ESTIVER ATIVADA:*\n`}
const smsAdveu2 = () => { return 'Razão'}
const smsAdveu3 = () => { return `${lenguajeEB['smsAvisoMG']()}*LEMBRE-SE DE ESCREVER O MOTIVO DO AVISO*\n`}
...
//grupo-kick.js
const smskick1 = () => { return `${lenguajeEB['smsAvisoAG']()}*MARQUE A PESSOA OU RESPONDA A MENSAGEM DA PESSOA QUE DESEJA EXCLUIR*\n\n*EXEMPLO: `}
...
//grupo-setbye.js
const smsSetB = () => { return `${lenguajeEB['smsAvisoEG']()}*A DESPEDIDA DO GRUPO ESTÁ CONFIGURADA*`}
const smsSetB2 = () => { return `${lenguajeEB['smsAvisoIIG']()}🙌 *_ESCREVA A MENSAGEM DE ADEUS_*\n*_OPCIONAL VOCÊ PODE USAR WHAT IS COM "@" PARA ADICIONAR MAIS INFORMAÇÕES:_*\n\n*⚡ @user (Menção ao usuário)*\n\n*LEMBRE-SE QUE O "@" É OPCIONAL*`}

//grupo-setwelcome.js
const smsSetW = () => { return `${lenguajeEB['smsAvisoEG']()}*AS BOAS-VINDAS DO GRUPO FOI CONFIGURADA*`}
const smsSetW2 = () => { return `${lenguajeEB['smsAvisoIIG']()}🙌 *_ESCREVA A MENSAGEM DE BEM-VINDO_*\n*_OPCIONAL VOCÊ PODE USAR WHAT IS COM "@" PARA ADICIONAR MAIS INFORMAÇÕES:_*\n\n*⚡ @user (Menção ao usuário)*\n*⚡ @subject (Nome do grupo)*\n*⚡ @desc (Descrição do grupo)*\n\n*LEMBRE-SE QUE OS "@" SÃO OPCIONAIS*`}

//grupo-setdesc.js
const smsDest = () => { return `${lenguajeEB['smsAvisoEG']()}*A DESCRIÇÃO DO GRUPO FOI CONFIGURADA*`}

//grupo-setname.js
const smsNam1 = () => { return `${lenguajeEB['smsAvisoEG']()}*O NOME DO GRUPO FOI DEFINIDO*`}
const smsNam2 = () => { return `${lenguajeEB['smsAvisoMG']()}*🙌 ESCREVA O NOME DO NOVO GRUPO*`}
const smsNam3 = () => { return `${lenguajeEB['smsAvisoFG']()}*O NOME DO GRUPO NÃO DEVE TER MAIS DE 25 CARACTERES*`}

//grupo-restaurarEnlace.js
const smsRestGp = () => { return `${lenguajeEB['smsAvisoEG']()}*O LINK DO GRUPO FOI REINICIALIZADO*`}
...
const smsSoloOwnerJB = () => { return `${lenguajeEB['smsAvisoAG']()}*ESTE COMANDO ESTÁ DESATIVADO PELO MEU PROPRIETÁRIO*`}
const smsJBPrincipal = () => { return `${lenguajeEB['smsAvisoAG']()}🔵 *PARA SER UM SUB BOT VAI AO NÚMERO PRINCIPAL*\n*ღ Entre no seguinte link:*\n`}
const smsJBConexion = () => { return `${lenguajeEB['smsAvisoFG']()}🟡 *A CONEXÃO FOI FECHADA DE FORMA INESPERADA, TENTAREMOS RECONECTAR...*`}
const smsJBConexionClose = () => { return `${lenguajeEB['smsAvisoFG']()}🔴 *A CONEXÃO FOI FECHADA, VOCÊ DEVE CONECTAR MANUALMENTE ATRAVÉS DO #jadibot COMANDO E ESCANEAR O NOVO CÓDIGO QR*`}
const smsJBConexionTrue = () => { return `${lenguajeEB['smsAvisoEG']()}🟢 *CONEXÃO COM SUCESSO!!!*`}
const smsJBConexionTrue2 = () => { return `${lenguajeEB['smsAvisoEG']()}🟢 *CONEXÃO COM SUCESSO!!! VOCÊ PODE SE CONECTAR USANDO:*`}
const smsJBCargando = () => { return `${lenguajeEB['smsAvisoIIG']()}⚪ *ESTÁ CONECTADO!! AGUARDE AS MENSAGENS ESTÃO CARREGANDO...*\n\n♻️ *OPÇÕES DISPONÍVEIS:*\n*» #stop _(Recurso Parar Subbot)_*\n*» #deletesesion _(Exclua todos os vestígios de Sub Bot)_*\n*» #jadibot _(Obtenha um novo código QR para ser Sub Bot)_*`}
...
const smsJBDel = () => { return `${lenguajeEB['smsAvisoAG']()}*USE ESTE COMANDO PARA O BOT PRINCIPAL*`}
const smsJBAdios = () => { return `${lenguajeEB['smsAvisoEG']()}*VOU SENTIR SAUDADES ${global.packname} TCHAU!! 🥹*`}
const smsJBCerrarS = () => { return `${lenguajeEB['smsAvisoEG']()}*VOCÊ SAIU E EXCLUIU TODOS OS RASTREIOS*`}
const smsJBErr = () => { return `*YOU HAVE LOGGED OUT AS A SUB BOT* ♻️`}

//comandos+18-adult.js
const smsContAdult = () => { return `${lenguajeEB['smsAvisoAG']()}*OS COMANDOS 🔞 ELES ESTÃO DESATIVADOS, SE VOCÊ FOR MEU CRIADOR, USE #on modohorny*`}
